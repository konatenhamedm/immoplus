...
const INDEX_ROOT_NAME = 'app_comptabilite_factureloc_index';
    ...
    , 'render' => function ($value, Factureloc $context) use ($renders) {
    $options = [
    ...
    'actions' => [
    'edit' => [
    'url' => $this->generateUrl('app_comptabilite_factureloc_edit', ['id' => $value])
    , 'ajax' => true
    , 'icon' => '%icon% bi bi-pen'
    ...
    'show' => [
    'url' => $this->generateUrl('app_comptabilite_factureloc_show', ['id' => $value])
    , 'ajax' => true
    , 'icon' => '%icon% bi bi-eye'
    ...
    'url' => $this->generateUrl('app_comptabilite_factureloc_delete', ['id' => $value])
    , 'ajax' => true
...
'factureloc' => $factureloc,
    ...
    #[Route('/{id}/edit', name: 'app_comptabilite_factureloc_edit', methods: ['GET', 'POST'])]
    public function edit(Request $request, Factureloc $factureloc, FacturelocRepository $facturelocRepository, FormError $formError): Response
{
