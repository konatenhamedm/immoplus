...
{
const INDEX_ROOT_NAME = 'app_terrains_site_index';

    #[Route('/', name: 'app_terrains_site_index', methods: ['GET', 'POST'])]
...
$isAjax = $request->isXmlHttpRequest();
    ...
    if ($form->isSubmitted()) {
    $response = [];
    $redirect = $this->generateUrl('app_terrains_site_index');
