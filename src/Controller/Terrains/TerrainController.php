...
{
const INDEX_ROOT_NAME = 'app_terrains_terrain_index';

    #[Route('/', name: 'app_terrains_terrain_index', methods: ['GET', 'POST'])]
    ...
    ->setName('dt_app_terrains_terrain');
    if($permission != null){
    ...
    public function new(Request $request, TerrainRepository $terrainRepository, FormError $formError): Response
{
$terrain = new Terrain();
...
$isAjax = $request->isXmlHttpRequest();
    ...
    if ($form->isSubmitted()) {
    $response = [];
    $redirect = $this->generateUrl('app_terrains_terrain_index');
...
'terrain' => $terrain,
    ...
    public function edit(Request $request, Terrain $terrain, TerrainRepository $terrainRepository, FormError $formError): Response
{
