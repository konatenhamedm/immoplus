...
class Locataire
{
    ...
    #[ORM\Column(length: 255)]
    private ?FichierAdmin $ScanPiece = null;
    ...
    public function setInfoPiece(string $FichierAdmin): static
    {
        $this->FichierAdmin = $InfoPiece;

        return $this;
    }

    public function getScanPiece(): ?FichierAdmin
    {
        return $this->ScanPiece;
    }

    public function setScanPiece(FichierAdmin $ScanPiece): static
    {
