...
#[Route('/new', name: 'app_parametre_jours_mois_entreprise_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $entityManager, JoursMoisEntreprise $joursMoisEntreprise, FormError $formError,JoursMoisEntrepriseRepository $jourRepo): Response
{
...
$isAjax = $request->isXmlHttpRequest();
    ...
    $company = $joursMoisEntreprise->findBy($jourRepo->Id());
dd($company);
    if ($form->isValid()) {
