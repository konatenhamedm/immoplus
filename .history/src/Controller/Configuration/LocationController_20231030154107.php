...
class LocationController extends BaseController
{
    ...
    const INDEX_ROOT_NAME_MAISON = 'app_config_location_maisons_index';
    ...
    public function index(Request $request, Breadcrumb $breadcrumb): Response
    {
        ...
        $modules = [
            [
                'label' => 'Général',
                'icon' => 'bi bi-list',
                'href' => $this->generateUrl('app_config_location_ls', ['module' => 'config'])
            ],
            [
                'label' => 'Ressource humaine',
                'icon' => 'bi bi-truck',
                'href' => $this->generateUrl('app_config_location_ls', ['module' => 'rh'])
            ],
            [
    ...
    #[Route(path: '/maisons', name: 'app_config_location_maisons_index', methods: ['GET', 'POST'])]
    public function indexMaison(Request $request, Breadcrumb $breadcrumb): Response
    {
        ...
        $modules = [
            [
                'label' => 'Les villes',
                'icon' => 'bi bi-list',
                'href' => $this->generateUrl('app_location_ville_index')
            ],
            [
                'label' => 'Les quartiers',
                'icon' => 'bi bi-truck',
                'href' => $this->generateUrl('app_location_quartier_index')
            ],
            [
                'label' => 'Les types de maison',
                'icon' => 'bi bi-users',
                'href' => $this->generateUrl('app_location_Typemaison_index')
            ],[
                'label' => 'Les maisons',
                'icon' => 'bi bi-users',
                'href' => $this->generateUrl('app_location_maison_index')
            ],
        ...
        return $this->render('config/location/maison/index.html.twig', [
            'modules' => $modules,
            'breadcrumb' => $breadcrumb,
            'permition' => $permission
        ]);
