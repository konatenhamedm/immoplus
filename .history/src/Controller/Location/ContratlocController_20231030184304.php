...
const INDEX_ROOT_NAME = 'app_location_contratloc_index';
    ...
    $table = $dataTableFactory->create()
            ...
            ->add('locataire',TextColumn::class, ['label' => 'Identifiant'])
            ->add('appartement',TextColumn::class, ['label' => 'Identifiant'])
            ->add('MntLoyer',TextColumn::class, ['label' => 'Identifiant'])
            ->add('MntCaution',TextColumn::class, ['label' => 'Identifiant'])
            ->add('MntAvance',TextColumn::class, ['label' => 'Identifiant'])
            ->add('TotVerse',TextColumn::class, ['label' => 'Identifiant'])
