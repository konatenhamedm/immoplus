...
const INDEX_ROOT_NAME = 'app_location_locataire_index';
    ...
    $table = $dataTableFactory->create()
            ...
            ->add('InfoPiece', TextColumn::class, ['label' => 'Nationna'])
            ->add('NPrenoms', TextColumn::class, ['label' => 'Identifiant'])
            ->add('Profession',TextColumn::class, ['label' => 'Identifiant'])
            ->add('Contacts',TextColumn::class, ['label' => 'Identifiant'])
            ->add('Email',TextColumn::class, ['label' => 'Identifiant'])
            ->add('InfoPiece',TextColumn::class, ['label' => 'Identifiant'])
